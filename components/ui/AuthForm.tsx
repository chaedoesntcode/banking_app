        ...
        <section className='auth-form'>
            <header className='flex flex-col gap-5 md:gap-8'>
                <Link href='/' className="cursor-pointer flex items-center gap-1">
                    <Image src='/icons/logo.svg' width={34} height={34} alt="Well logo" />
                    <h1 className="text-26 font-ibm-plex-serif font-bold text-black-1 flex flex-col">Well</h1>
                </Link>
            ...
            {
                user ? (
                    <div className="flex flex-col gap-4">plaid link for bank account</div>
                ) : (
                    <>
                        <Form {...form}>
                            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                                {
                                    type === 'sign-up' && (
                                        <>
                                            ...
                                            name="postalCode"
                                            label="Postal Code"
                                            placeholder="ex. 53702"
                                            type="text"
                                            inputMode="decimal"
                                            />
                                            </div>
                                            <div className="flex gap-4 justi">
                                            <CustomFormField 
                                            control={form.control}
                                            name="dateOfBirth"
                                            label="Date of Birth"
